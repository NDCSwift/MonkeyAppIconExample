...
[![Watch on YouTube](https://img.shields.io/badge/YouTube-Watch%20the%20Tutorial-red?style=for-the-badge&logo=youtube)](https://youtu.be/srOFdUvRmsc)
...
### 1. Clone the Repo
```bash
git clone https://github.com/NDCSwift/MonkeyAppIconExample.git
cd MonkeyAppIconExample
```

### 2. Open in Xcode
Double-click `MonkeyApp.xcodeproj`.
...
## 🛠️ Notes
- Open `MonkeyIcon.icon` in Icon Composer to inspect or modify the Liquid Glass settings.
- Replace the source PNG with your own AI-generated image to create a custom Liquid Glass icon.

## 📦 Requirements
- Xcode 26 beta+
- iOS 26+

📺 [Watch the guide on YouTube](https://youtu.be/srOFdUvRmsc)
